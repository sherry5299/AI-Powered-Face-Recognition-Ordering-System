...
📌 最新功能更新 (New Features)
- 後台新增「訂單搜尋 + 狀態/付款/日期篩選」。
- 新增「日期區間營收統計報表」與「熱門品項排行榜」。
- 後台可直接「編輯訂單內容」並保存。
- 支援 CSV 匯出訂單報表。
- 客戶端新增「排序」「購物車結帳預覽」「會員折扣」。
- 新增「菜單分類篩選」「新品/熱門標籤」。
- 修改後端：自然號碼會員 ID 回收 + 刪除會員照片。

✅ 版本紀錄 (Short Changelog)
- v1.2: 全面型後台訂單管理、CSV 匯出、訂單內容即時編輯
- v1.1: 加入後台訂單搜尋與營收報表功能
- v1.0: 基本 Kiosk + 人臉會員 + 管理後台功能
